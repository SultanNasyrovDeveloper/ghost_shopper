    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('patronymic', models.CharField(blank=True, max_length=70, verbose_name='Отчество')),
                ('phone_number', models.CharField(blank=True, max_length=30, verbose_name='Контактный номер')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('built_year', models.PositiveSmallIntegerField(default=1990, verbose_name='Год выпуска')),
                ('owns_from', models.DateField(verbose_name='В собственности с')),
